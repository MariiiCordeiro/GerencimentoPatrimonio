...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=GestaoPatrimonios;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Area>(entity =>
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B82028DA781E67");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A7797609CE94AD2").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A0936238D645D32");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED0BF56894");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE07E31422").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B68009592BBEB0F9");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F561AB187");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA9DCB66F7");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12BFA0CF61D");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDEDD43B42A");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35D6C8381B3").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2C9763E1E");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336094CBE6FBE");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1AE433EDB6").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9D8E9DFF3");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A461ACBFE").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DCC35311F");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10A64A85B49").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C7021B4C6319");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A9B72A719").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798C7C1EAE8");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C873D0AE02").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA24DBC8733").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053470191F7A").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731E35EB28E").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC330AE6C257E").IsUnique();
